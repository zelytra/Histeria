...
public enum CustomMaterial {
    ...
    ANTI_NOCTURITE_SWORD("§5Anti-Nocturite Sword", "anti-nocturite_sword", "Durabilité: 3600#Pouvoir: attire ses enemies", 52, Material.STONE_SWORD, ItemType.TOOL, 4000, 13, EquipmentSlot.HAND),
    NOCTURITE_SWORD("§5Nocturite Sword", "nocturite_sword", "Durabilité: 3600#Pouvoir: projette toute entité alentour", 30, Material.STONE_SWORD, ItemType.TOOL, 3600, 12, EquipmentSlot.HAND),
    HISTERITE_SWORD("§cHisterite Sword", "histerite_sword", "Durabilité: 2800", 28, Material.STONE_SWORD, ItemType.TOOL, 2800, 10, EquipmentSlot.HAND),
