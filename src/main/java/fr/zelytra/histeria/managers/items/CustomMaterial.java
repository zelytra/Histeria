...
public enum CustomMaterial {
    ...
    ANTI_NOCTURITE_SWORD("§5Anti-Nocturite Sword", "anti-nocturite_sword", "Durabilité: 3600#Pouvoir: attire ses enemies", 52, Material.GOLDEN_SWORD, ItemType.TOOL, 4000, 13, EquipmentSlot.HAND),
